...
def robustness(data, raw, trajectory_proposed):
    ...
    # Compute ETTC
    min_vehicle_ttc = calculate_ettc(
        car_positions, car_velocities
    )
    ...
    results = torch.zeros_like(delta_vehicle_ttc , device='cuda')
